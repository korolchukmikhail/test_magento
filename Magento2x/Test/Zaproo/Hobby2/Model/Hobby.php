...
class Hobby
{
    ...
    public function saveUserHobby(int $hobby, int $customerId = null)
    {
    ...
    public function getUserHobby(): int
    {
        $hobby = 0;
    ...
    public function getUserHobbyText(): string
    {
        $hobby = '';
        $customerId = $this->customerSession->getId();

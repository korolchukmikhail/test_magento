...
class Onilab_TooltipOption_Block_Catalog_Product_View_Type_Bundle_Option_Radio extends Mage_Bundle_Block_Catalog_Product_View_Type_Bundle_Option_Radio
{
    ...
    public function __construct()
    {
        ...
        $this->setTemplate('onilab/tooltipoption/bundle/catalog/product/view/type/bundle/option/radio.phtml');
    }

...
class Onilab_TooltipOption_Block_Catalog_Product_View_Type_Bundle_Option_Select extends Mage_Bundle_Block_Catalog_Product_View_Type_Bundle_Option_Select
{
    ...
    public function __construct()
    {
        ...
        $this->setTemplate('onilab/tooltipoption/bundle/catalog/product/view/type/bundle/option/select.phtml');
    }
